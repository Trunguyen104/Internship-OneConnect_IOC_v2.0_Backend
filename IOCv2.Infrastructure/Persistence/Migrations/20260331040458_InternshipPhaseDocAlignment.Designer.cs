...
namespace IOCv2.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260331040458_InternshipPhaseDocAlignment")]
    partial class InternshipPhaseDocAlignment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IOCv2.Domain.Entities.InternshipPhase", b =>
                {
                    ...
                    b.ToTable("internship_phases", null, t =>
                        {
                            t.HasCheckConstraint("ck_internship_phases_capacity_min", "capacity >= 1");
                        });
                });
