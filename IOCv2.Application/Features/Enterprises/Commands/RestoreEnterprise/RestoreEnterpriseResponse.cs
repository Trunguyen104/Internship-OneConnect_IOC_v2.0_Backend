...
{
    public class RestoreEnterpriseResponse : IMapFrom<Enterprise>
    {
        ...
        {
            profile.CreateMap<Enterprise, RestoreEnterpriseResponse>()
                    .ForMember(dest => dest.Status,
                        opt => opt.MapFrom(src => (EnterpriseStatus)src.Status));
            profile.CreateMap<RestoreEnterpriseResponse, Enterprise>()
                .ForMember(dest => dest.Status,
