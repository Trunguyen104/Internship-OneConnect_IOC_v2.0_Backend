...
{
    public class DeleteEnterpriseResponse : IMapFrom<Enterprise>
    {
        ...
        public void Mapping(Profile profile) {
            profile.CreateMap<Enterprise, DeleteEnterpriseResponse>()
                    .ForMember(dest => dest.Status,
                        opt => opt.MapFrom(src => (EnterpriseStatus)src.Status));
                profile.CreateMap<DeleteEnterpriseResponse, Enterprise>()
                    .ForMember(dest => dest.Status,
